...
<body>
        ...
        <div class="panel-heading">
              ...
              <h2 style="font-size:2em;">Peace Officer </h2>
              <canvas id="myBarChart"></canvas>
                     ...
                     require '../dbconnector/dbcon.php';
                        ...
                        $query = $conn->query("SELECT c.candidate_id, c.firstname, (SELECT COUNT(*) FROM votes v WHERE v.candidate_id = c.candidate_id) as total FROM tbl_candidate c WHERE  position = 'Peace Officer' and status = 'approved'");
