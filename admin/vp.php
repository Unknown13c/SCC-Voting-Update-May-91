        ...
        <div class="panel-heading">
                  ...
                  <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <h2 style="font-size:2em;">Vice President</h2>
                     ...
                     require '../dbconnector/dbcon.php';
                        ...
                        $query = $conn->query("SELECT c.candidate_id, c.firstname, (SELECT COUNT(*) FROM votes v WHERE v.candidate_id = c.candidate_id) as total FROM tbl_candidate c WHERE  position = 'Vice President' and status = 'approved'");
