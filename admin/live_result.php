                  ...
                  <li class="nav-item">
                    ...
                    <li class="nav-item">
                     ...
                     require '../dbconnector/dbcon.php';
                        ...
                        $query = $conn->query("SELECT c.candidate_id, c.firstname, (SELECT COUNT(*) FROM votes v WHERE v.candidate_id = c.candidate_id) as total FROM tbl_candidate c WHERE  position = 'President' and status = 'approved'");
