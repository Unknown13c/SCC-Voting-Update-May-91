     ...
     <!-- Navigation bar-->
        ...
        <div class="panel-heading">
                  ...
                  <li class="nav-item">
                    ...
                    <li class="nav-item">
                         <a class="nav-link" style="font-weight:bold;color:red;" href="secretary.php">Secretary</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <h2 style="font-size:2em;">Secretary</h2>
                     ...
                     require '../dbconnector/dbcon.php';
                        ...
                        $query = $conn->query("SELECT c.candidate_id, c.firstname, (SELECT COUNT(*) FROM votes v WHERE v.candidate_id = c.candidate_id) as total FROM tbl_candidate c WHERE  position = 'Secretary' and status = 'approved'");
